---
title: "Web前端总结"
excerpt: "此报告为技术总结, 客观记录我所了解到的前端工程师可能用得上的技能, 行业发展状况以及前景. 因此会根据我的学习进度持续更新."
date: "2024-04-19"
---
...
- CSS 框架: Bootstrap, Tailwind(daisyUI, shadcnUI)
- 框架: React, Next.js, Vue, Vite, Nuxt
- 协议: HTTP, SSH, SSL
...
- 工具:
  ...
  - webpack, babel, Sass
  - ESLint, Prettier
  - MDX(markdown to components, next-mdx-remote), gray-matter
- 部署: Vercel, Github Page(静态), Render.com, DNS
